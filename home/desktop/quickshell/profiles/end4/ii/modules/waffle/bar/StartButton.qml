        ...
        model: [
            {
                ...
                action: () => {
                    LauncherApps.launchCommand(Config.options.apps.terminal);
                }
            },
            {
                text: Translation.tr("Task Manager"),
                action: () => {
                    LauncherApps.launchCommand(Config.options.apps.taskManager);
                }
            },
            {
            ...
            },
            {
                ...
                action: () => {
                    LauncherApps.launchCommand("xdg-open " + StringUtils.shellSingleQuoteEscape(Directories.home));
                }
            },
            {
