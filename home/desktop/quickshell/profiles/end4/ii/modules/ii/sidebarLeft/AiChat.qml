        ...
        Rectangle { // Input area
            ...
            RowLayout { // Input field and send button
                ...
                StyledTextArea { // The actual TextArea
                    ...
                    placeholderText: Translation.tr('Message the model... "%1" for commands').arg("/")
            ...
            RowLayout { // Controls
                ...
                ApiInputBoxIndicator {
                    ...
                    tooltipText: Translation.tr("Current tool: %1\nSet it with %2tool TOOL").arg(Ai.currentTool).arg("/")
                }
                ...
                ButtonGroup {
                    ...
                    Repeater {
                        ...
                        delegate: ApiCommandButton {
                            property string commandRepresentation: `/${modelData.name}`
